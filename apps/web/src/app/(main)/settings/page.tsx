  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="space-y-8">
                    ...
                    <button
                      ...
                      className={`flex items-center gap-2 px-4 py-2 rounded-lg border transition-colors ${
                        theme === option.value
                          ...
                          : 'bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-300 border-gray-300 dark:border-gray-600 hover:border-orange-300'
                      }`}
                    >
        ...
        {/* Reading */}
        <section className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
          <h2 className="text-lg font-semibold mb-4 dark:text-white">Reading</h2>
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                  autoMarkRead ? 'bg-orange-500' : 'bg-gray-300 dark:bg-gray-600'
                }`}
              >
                <span
        ...
        {/* API Configuration */}
        <section className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
          <h2 className="text-lg font-semibold mb-4 dark:text-white">API Configuration</h2>
        ...
        <section className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
          ...
          <div className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
            <p><strong className="text-gray-900 dark:text-white">FeedGlow</strong> — Lightweight AI-powered RSS reader</p>
            <p>Version: 0.1.0</p>
            <p>
              <a
